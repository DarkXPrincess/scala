...
// Casos de prueba para distribucion
val esperadoD1 = List(
  List((1, 0))
)
val obtenidoD1 = distribucion(0, 1, 3)
assert(obtenidoD1 == esperadoD1)

val esperadoD2 = List(
  List((1, 3))
)
val obtenidoD2 = distribucion(3, 1, 3)
assert(obtenidoD2 == esperadoD2)
...
val obtenidoD3 = distribucion(2, 2, 2)
assert(obtenidoD3 == esperadoD3)

val esperadoD4 = List(
  List((1, 1), (2, 2)),
  List((1, 2), (2, 1))
)
val obtenidoD4 = distribucion(3, 2, 2)
assert(obtenidoD4 == esperadoD4)
